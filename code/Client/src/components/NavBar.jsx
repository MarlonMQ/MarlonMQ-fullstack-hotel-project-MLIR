...
function NavBar() {
  ...
  return (
    <Disclosure as="nav" className={`bg-transparent top-0 ${isHomePage ? 'absolute' : 'relative'} z-10 w-full mb-10`}>
      {({ open }) => (
        <>
          {!isHomePage && (
            <img 
              className="absolute brightness-50 inset-0 w-full h-full object-cover z-0" 
              src={image} 
