...
const CountryRegionSelector = ({ country, selectCountry, region, selectRegion, countryError, regionError, tabIndexCountry, tabIndexRegion }) => {
  return (
    <div className="flex flex-col">
      ...
      <label className="block mb-2 text-sm font-medium text-gray-900 w-1/2">Country</label>
      <CountryDropdown
      ...
      <div className="block mb-2 w-full ">
        <label className="block mb-2 text-sm font-medium text-gray-900 w-1/2">Region</label>
        <RegionDropdown
