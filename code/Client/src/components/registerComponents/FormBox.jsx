...
const FormBox = ({ title, error }) => {
    return (
        <div className="relative z-0 w-full mb-5 group">
            <input type="text" name="floating${title}" id="floating${title}" className={`block py-2.5 px-1 w-full text-sm text-gray-900 rounded-lg border-3 ${error ? 'border-red-500' : 'border-gray-300'} appearance-none dark:black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer left`} placeholder=" " />
