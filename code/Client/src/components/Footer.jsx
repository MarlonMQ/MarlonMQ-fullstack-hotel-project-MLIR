  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <footer className='w-full bg-primary text-white py-16 px-4'>
        <div className='grid grid-rows-1 sm:grid-cols-3 text-center'>
          ...
          <div className='py-8'>
            <ul className='grid grid-rows-3 '>
              <div className='grid grid-cols-2 py-3'>
                <i className="fa-brands fa-facebook fa-2x ml-auto pr-1"></i> 
                <li className='mr-auto pl-1 content-center hover:underline cursor-pointer'>Facebook</li>
              </div>
              <div className='grid grid-cols-2 py-3'>
                <i className="fa-brands fa-square-x-twitter fa-2x ml-auto pr-1"></i> 
                <li className='mr-auto pl-1 content-center hover:underline cursor-pointer'>Twitter</li>
              </div>
              <div className='grid grid-cols-2 py-3'>
                <i className="fa-brands fa-square-instagram fa-2x ml-auto pr-1"></i>
                <li className='mr-auto pl-1 content-center hover:underline cursor-pointer'>Instagram</li>
              </div>
            </ul>
          </div>
        </div>
