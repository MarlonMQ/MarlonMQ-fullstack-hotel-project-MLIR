...
var CountryDropdown = function(_Component) {
  ...
  createClass(CountryDropdown2, [{
    ...
    value: function render() {
      var _props3 = this.props, name = _props3.name, id = _props3.id, classes = _props3.classes, value = _props3.value, _onChange = _props3.onChange, _onBlur = _props3.onBlur, disabled = _props3.disabled, showDefaultOption = _props3.showDefaultOption, defaultOptionLabel = _props3.defaultOptionLabel, labelType = _props3.labelType, valueType = _props3.valueType, whitelist = _props3.whitelist, blacklist = _props3.blacklist, customOptions = _props3.customOptions, priorityOptions = _props3.priorityOptions, arbitraryProps = objectWithoutProperties(_props3, ["name", "id", "classes", "value", "onChange", "onBlur", "disabled", "showDefaultOption", "defaultOptionLabel", "labelType", "valueType", "whitelist", "blacklist", "customOptions", "priorityOptions"]);
...
CountryDropdown.propTypes = {
  ...
  showDefaultOption: import_prop_types.default.bool,
  defaultOptionLabel: import_prop_types.default.oneOfType([import_prop_types.default.string, import_prop_types.default.number]),
  priorityOptions: import_prop_types.default.array,
  onChange: import_prop_types.default.func,
  onBlur: import_prop_types.default.func,
  labelType: import_prop_types.default.oneOf([C.DISPLAY_TYPE_FULL, C.DISPLAY_TYPE_SHORT]),
  valueType: import_prop_types.default.oneOf([C.DISPLAY_TYPE_FULL, C.DISPLAY_TYPE_SHORT]),
  whitelist: import_prop_types.default.array,
  blacklist: import_prop_types.default.array,
...
var RegionDropdown = function(_PureComponent) {
  ...
  createClass(RegionDropdown2, [{
    ...
    key: "render",
    value: function render() {
      var _props5 = this.props, value = _props5.value, country = _props5.country, _onChange = _props5.onChange, _onBlur = _props5.onBlur, id = _props5.id, name = _props5.name, classes = _props5.classes, disabled = _props5.disabled, blankOptionLabel = _props5.blankOptionLabel, showDefaultOption = _props5.showDefaultOption, defaultOptionLabel = _props5.defaultOptionLabel, labelType = _props5.labelType, valueType = _props5.valueType, countryValueType = _props5.countryValueType, disableWhenEmpty = _props5.disableWhenEmpty, customOptions = _props5.customOptions, arbitraryProps = objectWithoutProperties(_props5, ["value", "country", "onChange", "onBlur", "id", "name", "classes", "disabled", "blankOptionLabel", "showDefaultOption", "defaultOptionLabel", "labelType", "valueType", "countryValueType", "disableWhenEmpty", "customOptions"]);
...
RegionDropdown.propTypes = {
  ...
  countryValueType: import_prop_types.default.oneOf([C.DISPLAY_TYPE_FULL, C.DISPLAY_TYPE_SHORT]),
  value: import_prop_types.default.oneOfType([import_prop_types.default.string, import_prop_types.default.number]),
  name: import_prop_types.default.string,
  id: import_prop_types.default.string,
  classes: import_prop_types.default.string,
  blankOptionLabel: import_prop_types.default.string,
  showDefaultOption: import_prop_types.default.bool,
  defaultOptionLabel: import_prop_types.default.string,
  onChange: import_prop_types.default.func,
  onBlur: import_prop_types.default.func,
  labelType: import_prop_types.default.string,
  valueType: import_prop_types.default.string,
  whitelist: import_prop_types.default.object,
  blacklist: import_prop_types.default.object,
  disabled: import_prop_types.default.bool,
  disableWhenEmpty: import_prop_types.default.bool,
  customOptions: import_prop_types.default.array
};
